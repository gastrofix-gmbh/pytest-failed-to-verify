# -*- coding: utf-8 -*-
#
# pytest-gfix documentation build configuration file, created by
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-gfix Documentation',
     [author], 1)
]
